...
\begin{figure}[H]
  ...
  \begin{tblr}{c|c||c|c}
    ...
    \midrule
    \includestandalone{figures/fig_073} & $S = \frac{BH^2}{6}-\frac{bh^3}{6H}$ & \includestandalone{figures/fig_074} & $S = \frac{B^2\left(H-h\right)}{6} + \frac{(B-b)^3 \cdot h}{6B}$ \\
    \includestandalone{figures/fig_075} & $S = \frac{BH^2}{6} - \frac{bh^3}{6H}$ & \includestandalone{figures/fig_077} & $S = \frac{\pi \left( R^4 - r^4 \right)}{4R}$ \\
    \includestandalone{figures/fig_076} & $S = \frac{BH^2}{24}$ & \includestandalone{figures/fig_078} & $S = \frac{BH^2}{6} - \frac{bh^3}{6H}$ \\
    \bottomrule
  \end{tblr}
